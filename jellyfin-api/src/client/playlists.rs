...
impl Client {
    ...
    pub async fn get_playlist(
        ...
        self.request(
            reqwest::Method::GET,
            format!("/Playlists/{}", encode_path(&playlist_id.to_string())),
        )
        .send()
        .await
    }
    ...
    pub async fn remove_item_from_playlist(
        ...
        self.request(
            ...
            format!("/Playlists/{}/Items", encode_path(playlist_id)),
        )
    ...
    pub async fn get_playlist_users(
        ...
        self.request(
            reqwest::Method::GET,
            format!("/Playlists/{}/Users", encode_path(&playlist_id.to_string())),
        )
        .send()
        .await
    }
    ...
    pub async fn get_playlist_user(
        ...
        self.request(
            ...
            format!(
                "/Playlists/{}/Users/{}",
                encode_path(&playlist_id.to_string()),
