...
impl Client {
    ...
    pub async fn get_genre(
        ...
        self.request(
            reqwest::Method::GET,
            format!("/Genres/{}", encode_path(genre_name)),
        )
    ...
    pub async fn get_genre_image_by_index(
        ...
        image_type: types::ImageType,
        image_index: i32,
        query: &query::GetGenreImageByIndex<'_>,
    ) -> Result<reqwest::Response, Error> {
        self.request(
            reqwest::Method::GET,
            format!(
    ...
    pub async fn head_genre_image_by_index(
        ...
        image_type: types::ImageType,
        image_index: i32,
        query: &query::HeadGenreImageByIndex<'_>,
    ) -> Result<reqwest::Response, Error> {
        self.request(
            reqwest::Method::HEAD,
            format!(
