...
impl Client {
    ...
    pub async fn get_default_directory_browser(
        ...
        self.request(
            reqwest::Method::GET,
            "/Environment/DefaultDirectoryBrowser".into(),
        )
        .send()
        .await
    }
    ...
    pub async fn get_directory_contents(
        ...
        self.request(
            reqwest::Method::GET,
            "/Environment/DirectoryContents".into(),
        )
    ...
    pub async fn get_drives(&self) -> Result<Vec<types::FileSystemEntryInfo>, Error> {
    ...
    pub async fn get_network_shares(&self) -> Result<Vec<types::FileSystemEntryInfo>, Error> {
    ...
    pub async fn get_parent_path(&self, path: &str) -> Result<String, Error> {
    ...
    pub async fn validate_path(&self, body: &types::ValidatePathDto) -> Result<(), Error> {
