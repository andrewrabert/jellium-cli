...
impl Client {
    ...
    pub async fn get_artist_by_name(
        ...
        self.request(reqwest::Method::GET, format!("/Artists/{}", encode_path(name)))
            .query_opt("userId", user_id)
            .send()
            .await
    }
    ...
    pub async fn get_artist_image(
        ...
        self.request(reqwest::Method::GET, format!("/Artists/{}/Images/{}/{}", encode_path(name), encode_path(&image_type.to_string()), encode_path(&image_index.to_string())))
    ...
    pub async fn head_artist_image(
        ...
        self.request(reqwest::Method::HEAD, format!("/Artists/{}/Images/{}/{}", encode_path(name), encode_path(&image_type.to_string()), encode_path(&image_index.to_string())))
            .query_opt("backgroundColor", background_color)
            .query_opt("blur", blur)
            .query_opt("fillHeight", fill_height)
            .query_opt("fillWidth", fill_width)
    ...
    pub async fn get_instant_mix_from_album(
        ...
        self.request(reqwest::Method::GET, format!("/Albums/{}/InstantMix", encode_path(&item_id.to_string())))
            .query_list_opt("enableImageTypes", enable_image_types)
            .query_opt("enableImages", enable_images)
            .query_opt("enableUserData", enable_user_data)
            .query_list_opt("fields", fields)
    ...
    pub async fn get_instant_mix_from_artists(
        ...
        self.request(reqwest::Method::GET, format!("/Artists/{}/InstantMix", encode_path(&item_id.to_string())))
            .query_list_opt("enableImageTypes", enable_image_types)
            .query_opt("enableImages", enable_images)
            .query_opt("enableUserData", enable_user_data)
            .query_list_opt("fields", fields)
    ...
    pub async fn get_instant_mix_from_song(
        ...
        self.request(reqwest::Method::GET, format!("/Songs/{}/InstantMix", encode_path(&item_id.to_string())))
            .query_list_opt("enableImageTypes", enable_image_types)
            .query_opt("enableImages", enable_images)
            .query_opt("enableUserData", enable_user_data)
            .query_list_opt("fields", fields)
    ...
    pub async fn get_similar_albums(
        ...
        self.request(reqwest::Method::GET, format!("/Albums/{}/Similar", encode_path(&item_id.to_string())))
    ...
    pub async fn get_similar_artists(
        ...
        self.request(reqwest::Method::GET, format!("/Artists/{}/Similar", encode_path(&item_id.to_string())))
            .query_list_opt("excludeArtistIds", exclude_artist_ids)
            .query_list_opt("fields", fields)
            .query_opt("limit", limit)
            .query_opt("userId", user_id)
