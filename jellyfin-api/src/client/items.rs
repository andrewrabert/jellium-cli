...
impl Client {
    ...
    pub async fn get_item_image_infos(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/Images", encode_path(&item_id.to_string())))
            .send()
            .await
    }
    ...
    pub async fn get_item_image(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/Images/{}", encode_path(&item_id.to_string()), encode_path(&image_type.to_string())))
    ...
    pub async fn set_item_image<B: Into<reqwest::Body>>(
        ...
        self.request(reqwest::Method::POST, format!("/Items/{}/Images/{}", encode_path(&item_id.to_string()), encode_path(&image_type.to_string())))
    ...
    pub async fn delete_item_image(
        ...
        self.request(reqwest::Method::DELETE, format!("/Items/{}/Images/{}", encode_path(&item_id.to_string()), encode_path(&image_type.to_string())))
            .query_opt("imageIndex", image_index)
            .send_no_content()
            .await
    }
    ...
    pub async fn head_item_image(
        ...
        self.request(reqwest::Method::HEAD, format!("/Items/{}/Images/{}", encode_path(&item_id.to_string()), encode_path(&image_type.to_string())))
            .query_opt("backgroundColor", background_color)
            .query_opt("blur", blur)
            .query_opt("fillHeight", fill_height)
            .query_opt("fillWidth", fill_width)
    ...
    pub async fn get_item_image_by_index(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/Images/{}/{}", encode_path(&item_id.to_string()), encode_path(&image_type.to_string()), encode_path(&image_index.to_string())))
            .query_opt("backgroundColor", background_color)
            .query_opt("blur", blur)
            .query_opt("fillHeight", fill_height)
            .query_opt("fillWidth", fill_width)
    ...
    pub async fn set_item_image_by_index<B: Into<reqwest::Body>>(
        ...
        self.request(reqwest::Method::POST, format!("/Items/{}/Images/{}/{}", encode_path(&item_id.to_string()), encode_path(&image_type.to_string()), encode_path(&image_index.to_string())))
            .raw_body(body, "application/octet-stream")
            .send_no_content()
            .await
    }
    ...
    pub async fn delete_item_image_by_index(
        ...
        self.request(reqwest::Method::DELETE, format!("/Items/{}/Images/{}/{}", encode_path(&item_id.to_string()), encode_path(&image_type.to_string()), encode_path(&image_index.to_string())))
            .send_no_content()
            .await
    }
    ...
    pub async fn head_item_image_by_index(
        ...
        self.request(reqwest::Method::HEAD, format!("/Items/{}/Images/{}/{}", encode_path(&item_id.to_string()), encode_path(&image_type.to_string()), encode_path(&image_index.to_string())))
            .query_opt("backgroundColor", background_color)
            .query_opt("blur", blur)
            .query_opt("fillHeight", fill_height)
            .query_opt("fillWidth", fill_width)
    ...
    pub async fn get_item_image2(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/Images/{}/{}/{}/{}/{}/{}/{}/{}", encode_path(&item_id.to_string()), encode_path(&image_type.to_string()), encode_path(&image_index.to_string()), encode_path(tag), encode_path(&format.to_string()), encode_path(&max_width.to_string()), encode_path(&max_height.to_string()), encode_path(&percent_played.to_string()), encode_path(&unplayed_count.to_string())))
            .query_opt("backgroundColor", background_color)
            .query_opt("blur", blur)
            .query_opt("fillHeight", fill_height)
            .query_opt("fillWidth", fill_width)
    ...
    pub async fn head_item_image2(
        ...
        self.request(reqwest::Method::HEAD, format!("/Items/{}/Images/{}/{}/{}/{}/{}/{}/{}/{}", encode_path(&item_id.to_string()), encode_path(&image_type.to_string()), encode_path(&image_index.to_string()), encode_path(tag), encode_path(&format.to_string()), encode_path(&max_width.to_string()), encode_path(&max_height.to_string()), encode_path(&percent_played.to_string()), encode_path(&unplayed_count.to_string())))
            .query_opt("backgroundColor", background_color)
            .query_opt("blur", blur)
            .query_opt("fillHeight", fill_height)
            .query_opt("fillWidth", fill_width)
    ...
    pub async fn update_item_image_index(
        ...
        self.request(reqwest::Method::POST, format!("/Items/{}/Images/{}/{}/Index", encode_path(&item_id.to_string()), encode_path(&image_type.to_string()), encode_path(&image_index.to_string())))
    ...
    pub async fn get_instant_mix_from_item(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/InstantMix", encode_path(&item_id.to_string())))
    ...
    pub async fn get_external_id_infos(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/ExternalIdInfos", encode_path(&item_id.to_string())))
            .send()
            .await
    }
    ...
    pub async fn apply_search_criteria(
        ...
        self.request(reqwest::Method::POST, format!("/Items/RemoteSearch/Apply/{}", encode_path(&item_id.to_string())))
    ...
    pub async fn get_music_album_remote_search_results(
        ...
        self.request(reqwest::Method::POST, "/Items/RemoteSearch/MusicAlbum".into())
            .json_body(body)
            .send()
            .await
    }
    ...
    pub async fn get_music_artist_remote_search_results(
        ...
        self.request(reqwest::Method::POST, "/Items/RemoteSearch/MusicArtist".into())
            .json_body(body)
            .send()
            .await
    }
    ...
    pub async fn get_music_video_remote_search_results(
        ...
        self.request(reqwest::Method::POST, "/Items/RemoteSearch/MusicVideo".into())
            .json_body(body)
            .send()
            .await
    }
    ...
    pub async fn refresh_item(
        ...
        self.request(reqwest::Method::POST, format!("/Items/{}/Refresh", encode_path(&item_id.to_string())))
    ...
    pub async fn get_item(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}", encode_path(&item_id.to_string())))
            .query_opt("userId", user_id)
            .send()
            .await
    }
    ...
    pub async fn update_item(
        ...
        self.request(reqwest::Method::POST, format!("/Items/{}", encode_path(&item_id.to_string())))
            .json_body(body)
            .send_no_content()
            .await
    }
    ...
    pub async fn delete_item(
        ...
        self.request(reqwest::Method::DELETE, format!("/Items/{}", encode_path(&item_id.to_string())))
            .send_no_content()
            .await
    }
    ...
    pub async fn update_item_content_type(
        ...
        self.request(reqwest::Method::POST, format!("/Items/{}/ContentType", encode_path(&item_id.to_string())))
    ...
    pub async fn get_metadata_editor_info(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/MetadataEditor", encode_path(&item_id.to_string())))
            .send()
            .await
    }
    ...
    pub async fn get_ancestors(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/Ancestors", encode_path(&item_id.to_string())))
            .query_opt("userId", user_id)
            .send()
            .await
    }
    ...
    pub async fn get_critic_reviews(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/CriticReviews", encode_path(item_id)))
            .send()
            .await
    }
    ...
    pub async fn get_download(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/Download", encode_path(&item_id.to_string())))
            .send_response()
            .await
    }
    ...
    pub async fn get_file(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/File", encode_path(&item_id.to_string())))
            .send_response()
            .await
    }
    ...
    pub async fn get_similar_items(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/Similar", encode_path(&item_id.to_string())))
            .query_list_opt("excludeArtistIds", exclude_artist_ids)
            .query_list_opt("fields", fields)
            .query_opt("limit", limit)
            .query_opt("userId", user_id)
    ...
    pub async fn get_theme_media(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/ThemeMedia", encode_path(&item_id.to_string())))
    ...
    pub async fn get_theme_songs(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/ThemeSongs", encode_path(&item_id.to_string())))
            .query_opt("inheritFromParent", inherit_from_parent)
            .query_list_opt("sortBy", sort_by)
            .query_list_opt("sortOrder", sort_order)
            .query_opt("userId", user_id)
    ...
    pub async fn get_theme_videos(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/ThemeVideos", encode_path(&item_id.to_string())))
            .query_opt("inheritFromParent", inherit_from_parent)
            .query_list_opt("sortBy", sort_by)
            .query_list_opt("sortOrder", sort_order)
            .query_opt("userId", user_id)
    ...
    pub async fn get_similar_movies(
        ...
        self.request(reqwest::Method::GET, format!("/Movies/{}/Similar", encode_path(&item_id.to_string())))
            .query_list_opt("excludeArtistIds", exclude_artist_ids)
            .query_list_opt("fields", fields)
            .query_opt("limit", limit)
            .query_opt("userId", user_id)
    ...
    pub async fn get_similar_trailers(
        ...
        self.request(reqwest::Method::GET, format!("/Trailers/{}/Similar", encode_path(&item_id.to_string())))
            .query_list_opt("excludeArtistIds", exclude_artist_ids)
            .query_list_opt("fields", fields)
            .query_opt("limit", limit)
            .query_opt("userId", user_id)
    ...
    pub async fn get_playback_info(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/PlaybackInfo", encode_path(&item_id.to_string())))
            .query_opt("userId", user_id)
            .send()
            .await
    }
    ...
    pub async fn get_posted_playback_info(
        ...
        self.request(reqwest::Method::POST, format!("/Items/{}/PlaybackInfo", encode_path(&item_id.to_string())))
    ...
    pub async fn get_item_segments(
        ...
        self.request(reqwest::Method::GET, format!("/MediaSegments/{}", encode_path(&item_id.to_string())))
    ...
    pub async fn get_remote_images(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/RemoteImages", encode_path(&item_id.to_string())))
    ...
    pub async fn download_remote_image(
        ...
        self.request(reqwest::Method::POST, format!("/Items/{}/RemoteImages/Download", encode_path(&item_id.to_string())))
    ...
    pub async fn get_remote_image_providers(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/RemoteImages/Providers", encode_path(&item_id.to_string())))
            .send()
            .await
    }
    ...
    pub async fn search_remote_subtitles(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/RemoteSearch/Subtitles/{}", encode_path(&item_id.to_string()), encode_path(language)))
    ...
    pub async fn download_remote_subtitles(
        ...
        self.request(reqwest::Method::POST, format!("/Items/{}/RemoteSearch/Subtitles/{}", encode_path(&item_id.to_string()), encode_path(subtitle_id)))
            .send_no_content()
            .await
    }
    ...
    pub async fn get_intros(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/Intros", encode_path(&item_id.to_string())))
            .query_opt("userId", user_id)
            .send()
            .await
    }
    ...
    pub async fn get_local_trailers(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/LocalTrailers", encode_path(&item_id.to_string())))
            .query_opt("userId", user_id)
            .send()
            .await
    }
    ...
    pub async fn get_special_features(
        ...
        self.request(reqwest::Method::GET, format!("/Items/{}/SpecialFeatures", encode_path(&item_id.to_string())))
            .query_opt("userId", user_id)
            .send()
            .await
    }
    ...
    pub async fn get_year(
        ...
        self.request(reqwest::Method::GET, format!("/Years/{}", encode_path(&year.to_string())))
            .query_opt("userId", user_id)
            .send()
            .await
    }
