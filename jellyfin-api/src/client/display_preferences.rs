...
impl Client {
    ...
    pub async fn get_display_preferences(
        ...
        self.request(reqwest::Method::GET, format!("/DisplayPreferences/{}", encode_path(display_preferences_id)))
            .query("client", client)
    ...
    pub async fn update_display_preferences(
        ...
        self.request(reqwest::Method::POST, format!("/DisplayPreferences/{}", encode_path(display_preferences_id)))
            .query("client", client)
            .query_opt("userId", user_id)
            .json_body(body)
            .send_no_content()
