...
impl Client {
    ...
    pub async fn get_plugins(
        &self,
    ) -> Result<Vec<types::PluginInfo>, Error> {
    ...
    pub async fn uninstall_plugin(
        ...
        self.request(reqwest::Method::DELETE, format!("/Plugins/{}", encode_path(&plugin_id.to_string())))
            .send_no_content()
            .await
    }
    ...
    pub async fn uninstall_plugin_by_version(
        ...
        self.request(reqwest::Method::DELETE, format!("/Plugins/{}/{}", encode_path(&plugin_id.to_string()), encode_path(version)))
            .send_no_content()
            .await
    }
    ...
    pub async fn disable_plugin(
        ...
        self.request(reqwest::Method::POST, format!("/Plugins/{}/{}/Disable", encode_path(&plugin_id.to_string()), encode_path(version)))
            .send_no_content()
            .await
    }
    ...
    pub async fn enable_plugin(
        ...
        self.request(reqwest::Method::POST, format!("/Plugins/{}/{}/Enable", encode_path(&plugin_id.to_string()), encode_path(version)))
            .send_no_content()
            .await
    }
    ...
    pub async fn get_plugin_image(
        ...
        self.request(reqwest::Method::GET, format!("/Plugins/{}/{}/Image", encode_path(&plugin_id.to_string()), encode_path(version)))
            .send_response()
            .await
    }
    ...
    pub async fn get_plugin_configuration(
        &self,
        plugin_id: &uuid::Uuid,
    ) -> Result<types::BasePluginConfiguration, Error> {
        self.request(reqwest::Method::GET, format!("/Plugins/{}/Configuration", encode_path(&plugin_id.to_string())))
            .send()
            .await
    }
    ...
    pub async fn update_plugin_configuration(
        ...
        self.request(reqwest::Method::POST, format!("/Plugins/{}/Configuration", encode_path(&plugin_id.to_string())))
            .send_no_content()
            .await
    }
    ...
    pub async fn get_plugin_manifest(
        ...
        self.request(reqwest::Method::POST, format!("/Plugins/{}/Manifest", encode_path(&plugin_id.to_string())))
            .send_no_content()
            .await
    }
}
