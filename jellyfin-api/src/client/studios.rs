...
impl Client {
    ...
    pub async fn get_studio_image(
        ...
        self.request(reqwest::Method::GET, format!("/Studios/{}/Images/{}", encode_path(name), encode_path(&image_type.to_string())))
    ...
    pub async fn head_studio_image(
        ...
        self.request(reqwest::Method::HEAD, format!("/Studios/{}/Images/{}", encode_path(name), encode_path(&image_type.to_string())))
            .query_opt("backgroundColor", background_color)
            .query_opt("blur", blur)
            .query_opt("fillHeight", fill_height)
            .query_opt("fillWidth", fill_width)
    ...
    pub async fn get_studio_image_by_index(
        ...
        self.request(reqwest::Method::GET, format!("/Studios/{}/Images/{}/{}", encode_path(name), encode_path(&image_type.to_string()), encode_path(&image_index.to_string())))
            .query_opt("backgroundColor", background_color)
            .query_opt("blur", blur)
            .query_opt("fillHeight", fill_height)
            .query_opt("fillWidth", fill_width)
    ...
    pub async fn head_studio_image_by_index(
        ...
        self.request(reqwest::Method::HEAD, format!("/Studios/{}/Images/{}/{}", encode_path(name), encode_path(&image_type.to_string()), encode_path(&image_index.to_string())))
            .query_opt("backgroundColor", background_color)
            .query_opt("blur", blur)
            .query_opt("fillHeight", fill_height)
            .query_opt("fillWidth", fill_width)
    ...
    pub async fn get_studio(
        ...
        self.request(reqwest::Method::GET, format!("/Studios/{}", encode_path(name)))
            .query_opt("userId", user_id)
            .send()
            .await
    }
