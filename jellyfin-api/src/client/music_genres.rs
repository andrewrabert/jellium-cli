...
impl Client {
    ...
    pub async fn get_music_genre_image(
        ...
        query: &query::GetMusicGenreImage<'_>,
    ...
    pub async fn head_music_genre_image(
        ...
        name: &str,
        image_type: types::ImageType,
        query: &query::HeadMusicGenreImage<'_>,
    ) -> Result<reqwest::Response, Error> {
        self.request(
            reqwest::Method::HEAD,
            format!(
    ...
    pub async fn get_music_genre_image_by_index(
        ...
        image_type: types::ImageType,
        image_index: i32,
        query: &query::GetMusicGenreImageByIndex<'_>,
    ) -> Result<reqwest::Response, Error> {
        self.request(
            reqwest::Method::GET,
            format!(
    ...
    pub async fn head_music_genre_image_by_index(
        ...
        image_type: types::ImageType,
        image_index: i32,
        query: &query::HeadMusicGenreImageByIndex<'_>,
    ) -> Result<reqwest::Response, Error> {
        self.request(
            reqwest::Method::HEAD,
            format!(
    ...
    pub async fn get_instant_mix_from_music_genre_by_name(
        &self,
        name: &str,
        query: &query::GetInstantMixFromMusicGenreByName<'_>,
    ...
    pub async fn get_instant_mix_from_music_genre_by_id(
        &self,
        id: &uuid::Uuid,
        query: &query::GetInstantMixFromMusicGenreById<'_>,
    ) -> Result<types::BaseItemDtoQueryResult, Error> {
        self.request(reqwest::Method::GET, "/MusicGenres/InstantMix".into())
            .query_list_opt("enableImageTypes", query.enable_image_types)
            .query_opt("enableImages", query.enable_images)
            .query_opt("enableUserData", query.enable_user_data)
            .query_list_opt("fields", query.fields)
    ...
    #[doc = "Gets a music genre, by name\n\nSends a `GET` request to `/MusicGenres/{genreName}`\n\nArguments:\n- `genre_name`: The genre name.\n- `user_id`: Optional. Filter by user id, and attach user data.\n"]
