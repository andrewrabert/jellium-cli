...
impl Client {
    ...
    pub async fn get_packages(
        &self,
    ) -> Result<Vec<types::PackageInfo>, Error> {
    ...
    pub async fn get_package_info(
        ...
        self.request(reqwest::Method::GET, format!("/Packages/{}", encode_path(name)))
    ...
    pub async fn install_package(
        ...
        self.request(reqwest::Method::POST, format!("/Packages/Installed/{}", encode_path(name)))
            .query_opt("assemblyGuid", assembly_guid)
    ...
    pub async fn cancel_package_installation(
        ...
        self.request(reqwest::Method::DELETE, format!("/Packages/Installing/{}", encode_path(&package_id.to_string())))
            .send_no_content()
            .await
    }
    ...
    pub async fn get_repositories(
        &self,
    ) -> Result<Vec<types::RepositoryInfo>, Error> {
