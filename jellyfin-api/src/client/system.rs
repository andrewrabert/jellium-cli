...
impl Client {
    ...
    pub async fn get_configuration(&self) -> Result<types::ServerConfiguration, Error> {
    ...
    pub async fn get_named_configuration<T: serde::de::DeserializeOwned>(
        &self,
        key: &str,
    ) -> Result<T, Error> {
        self.request(
            reqwest::Method::GET,
            format!("/System/Configuration/{}", encode_path(key)),
        )
        .send()
        .await
    }
    ...
    pub async fn get_default_metadata_options(&self) -> Result<types::MetadataOptions, Error> {
        self.request(
            reqwest::Method::GET,
            "/System/Configuration/MetadataOptions/Default".into(),
        )
        .send()
        .await
    }
    ...
    pub async fn get_fallback_font_list(&self) -> Result<Vec<types::FontFile>, Error> {
    ...
    pub async fn get_fallback_font(&self, name: &str) -> Result<reqwest::Response, Error> {
        self.request(
            reqwest::Method::GET,
            format!("/FallbackFont/Fonts/{}", encode_path(name)),
        )
        .send_response()
        .await
    }
    ...
    pub async fn get_endpoint_info(&self) -> Result<types::EndPointInfo, Error> {
    ...
    pub async fn get_system_info(&self) -> Result<types::SystemInfo, Error> {
    ...
    pub async fn get_public_system_info(&self) -> Result<types::PublicSystemInfo, Error> {
    ...
    pub async fn get_system_storage(&self) -> Result<types::SystemStorageDto, Error> {
    ...
    pub async fn get_server_logs(&self) -> Result<Vec<types::LogFile>, Error> {
    ...
    pub async fn get_ping_system(&self) -> Result<String, Error> {
    ...
    pub async fn post_ping_system(&self) -> Result<String, Error> {
    ...
    pub async fn get_utc_time(&self) -> Result<types::UtcTimeResponse, Error> {
    ...
    pub async fn tmdb_client_configuration(&self) -> Result<types::ConfigImageTypes, Error> {
