...
/// What `/Genres` is narrowed by.
#[derive(Debug, Clone, Default)]
pub struct GetGenres<'q> {
...
/// What `/Genres/{name}/Images/{imageType}` is narrowed by.
#[derive(Debug, Clone, Default)]
pub struct GetGenreImage<'q> {
...
/// What `/Genres/{name}/Images/{imageType}/{imageIndex}` is narrowed by.
#[derive(Debug, Clone, Default)]
pub struct GetGenreImageByIndex<'q> {
    /// Optional. Apply a background color for transparent images.
    pub background_color: Option<&'q str>,
    /// Optional. Blur image.
    pub blur: Option<i32>,
...
/// What `/Genres/{name}/Images/{imageType}/{imageIndex}` is narrowed by.
#[derive(Debug, Clone, Default)]
pub struct HeadGenreImageByIndex<'q> {
    /// Optional. Apply a background color for transparent images.
    pub background_color: Option<&'q str>,
    /// Optional. Blur image.
    pub blur: Option<i32>,
