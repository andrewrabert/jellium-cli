...
const ICONS = [
    ...
    'check_box',
    'check_box_outline_blank', 'check_circle_outline', 'chevron_left',
    'chevron_right', 'close', 'closed_caption',
    ...
    'library_add', 'live_tv', 'lock', 'meeting_room', 'menu', 'mode_edit',
    'more_vert',
    'movie',
    ...
    'photo_album',
    'play_arrow', 'play_circle', 'play_circle_filled', 'playlist_add',
    'playlist_remove', 'queue', 'quiz', 'refresh',
